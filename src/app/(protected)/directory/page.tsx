...
const Directory = () => {
  return (
    <div className="group relative flex flex-col items-center justify-center gap-6 overflow-hidden rounded-2xl border border-white/10 bg-card-bg-100 p-8 text-center shadow-2xl transition-all duration-500 hover:scale-[1.02] md:p-12 w-full md:w-2/3 lg:w-2/4">
      ...
      <div className="absolute inset-0 rounded-2xl border-2 border-transparent bg-radial-[at_25%_25%] from-white/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
    </div>
  );
};
