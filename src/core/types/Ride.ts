...
export const RideSchema = z.object({
  ...
  destination: z.string().max(100,{ message: 'Destination can be a maximum of 100 characters' }),
  landmark: z.string().max(100,{ message: 'Landmark can be a maximum of 100 characters' }).nullable(),
  pickupLocation: z.string().max(100,{ message: 'Pickup Location can be a maximum of 100 characters' }),
  notes: z.string().max(255,{ message: 'Notes can be a maximum of 255 characters' }).nullable(),
