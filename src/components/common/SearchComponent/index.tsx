...
export const SearchComponent = () => {
  ...
  return (
    <div className="h-12 min-w-[40%] rounded-2xl border border-secondary-100/40  bg-secondary-100/5 items-center pl-6 py-4 flex flex-row text-secondary-100 placeholder:text-gray-500">
      <input
