...
export const SearchComponent = () => {
  ...
  return (
    <div className="h-12 min-w-[40%] rounded-2xl border border-secondary-100 bg-amber-100/60 items-center px-2 py-4 flex flex-row text-black placeholder:text-gray-500">
      <input
