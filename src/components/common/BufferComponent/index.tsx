...
export const BufferComponent = ({ message, icon }: { message: string; icon: string }) => {
  return (
    <div className="relative mx-auto mt-8 rounded-xl w-[85vw] md:w-[60vw] lg:w-[50vw] p-5 md:p-8 flex flex-col items-center justify-center gap-6 overflow-hidden border border-white/10 bg-card-bg-100 text-center shadow-2xl">
      ...
      <div className="space-y-2">
        <p className="text-text-one-100/80 text-center max-w-xs">{message}</p>
      </div>
