...
export const BufferComponent = ({message, icon}:{message:string, icon:string}) => {
  return (
    <div className="relative mx-auto rounded-xl w-[85vw] md:w-[60vw] lg:w-[50vw] p-5 md:p-8 flex flex-col items-center justify-center gap-6 overflow-hidden border border-white/10 bg-card-bg-100 text-center shadow-2xl">
