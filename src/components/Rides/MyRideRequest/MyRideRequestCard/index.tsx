...
export const MyRideRequestCard = ({ ride, trip, onCancel }: MyRideRequestCardProps) => {
  ...
  return (
    <div
      className={`flex flex-col border-2 rounded-xl w-[85vw] md:w-[60vw] lg:w-[50vw] p-5 md:p-6 bg-card-bg-100 hover:bg-radial-[at_25%_25%] from-bg-card-bg-100 to-primary-100 to-75% transition-all duration-300 relative overflow-hidden
