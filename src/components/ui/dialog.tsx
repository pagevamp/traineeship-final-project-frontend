  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-card-bg-100 w-[calc(100%-1rem)] max-w-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg p-6 shadow-lg duration-200 outline-none',
          className,
        )}
        {...props}
      >
...
export function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-lg leading-none font-semibold text-light-text-100', className)}
      {...props}
    />
  );
}
